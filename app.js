...
// API CONFIG
// ------------------------------------------------------------
const API_BASE_URL = "https://tracefeeder-api-eqeda0hxgwc2e5d6.ukwest-01.azurewebsites.net";
    ...
    try {
        ...
        await scanner.start(
            ...
            async (decodedText) => {
                ...
                try { await scanner.stop(); } catch (e) { console.warn("Stop warning:", e); }
                try { scanner.clear(); } catch (e) { console.warn("Clear warning:", e); }
